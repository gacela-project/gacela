...
- New `UPGRADE.md`: the 1.21 → 2.0 migration, ordered by how likely each change is to affect you, with the mechanical renames first and the type-hint change that only bites container-extending code last
