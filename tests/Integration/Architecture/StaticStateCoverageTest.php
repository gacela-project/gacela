...
final class StaticStateCoverageTest extends TestCase
{
    ...
    private const array OUTLIVES_RESET = [
        ...
        'ResolvableTypes::$suffixes' => 'configuration: the kinds the assembled gacela.php declared. resetCache() returns it to the four pillars, which is a reset rather than survival, and it is listed here because the reset is conditional on nothing else having declared since',
